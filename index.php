...
<html>
    ...
    <body>
        <div style="position:fixed;left:45%;top:30%;text-align:center;">
            <h1 style="font-family:Arial Black,sans-serif;font-size:100px;color:#E8B631;text-decoration:none;margin-bottom:unset;margin-top:unset;">87</h1>
            <p><a href="./content.php" style="font-family:Arial Black,sans-serif;font-size:40px;color:#E8B631;text-decoration:none;">Entrar</a></p>
        </div>
