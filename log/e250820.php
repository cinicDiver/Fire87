...
<html>
    <head>
        <title>Fire #87 - Log 25/08/20</title>
        <meta charset="utf-8">
    ...
    <body class="stdBody">
        <nav class="navb" id="navHead">
            <ul class="navl">
                ...
                <li class="navli"><a href="./e200820.php" class="nava">Anterior</a></li>
                <li class="navli"><a href="./elist.php" class="nava">Entradas</a></li>
                <li class="navli"><a href="./e270820.php" class="nava">Siguiente</a></li>
            </ul>
        </nav>
        <h1 class="title1">Sesión 25/08/2020</h1>
        <div></div>
        <div class="row">
            <div class="centercolumn">
                <div class="card">
                    <h2>El cambio (2009)</h2>
                    <h5>Abstracciones de la película</h5>
                    <p>Sugiere que el cambio sucede en 4 fases:</p>
                        <ul>
                            <li>Intenso</li>
                            <li>Sorpresivo</li>
                            <li>Benevolente</li>
                ...
                <div class="card">
                    <h2>El Ego</h2>
                    <h5>Trabajar el filtro del ego</h5>
                    <p>Comprender cómo trabaja el ego como filtro sobre los procesos personales para conseguir 
                        suprimir los efectos negativos de sobre estimar desde el ego.</p>
                </div>
                <div class="card">
                    <h2>Soy</h2>
                    <h5>Definir objetivos</h5>
                    <p>Desde la escencia poder desarrollar el ser para alcanzar los objetivos que se quieren, sin descuidar 
                        los filtros del ego.</p>
                </div>
            </div>
        </div>
