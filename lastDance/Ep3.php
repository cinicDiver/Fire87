...
<html>
    <head>
        <title>The Last Dance: Ep.3</title>
        <meta charset="UTF-8">
    ...
    <body class="stdBody">
        <nav class="navb" id="navHead">
            <ul class="navl">
                ...
                <li class="navli"><a class="nava" href="./Ep2.php">Anterior</a></li>
                <li class="navli"><a class="nava" href="./Ep4.php">Siguiente</a></li>
                <li class="navli"><a class="nava" href="../content.php">Contenido</a></li>
            </ul>
        </nav>
        <h1 class="title1">Episode 3</h1>
        <div></div>
